...
execute if score @s race_seconds matches 90.. run scoreboard players set @s race_timer 0
execute if score @s race_seconds matches 90.. run scoreboard players set @s race_seconds 0
